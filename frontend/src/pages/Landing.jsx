...
const features = [
  ...
  { icon: 'history', color: 'text-tertiary', bg: 'bg-tertiary/10', title: 'Full History', body: 'Every file transfer is logged. Download anything you\'ve received at any time.' },
      ...
      <header className="fixed top-0 w-full z-50 header-glass">
        <div className="max-w-6xl mx-auto px-6 md:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link to="/login" className="text-sm font-medium text-on-surface-variant hover:text-on-surface t px-4 py-2">
              Sign In
            </Link>
            <Link
              to="/register"
              className="flex items-center gap-1.5 px-5 py-2 bg-primary text-on-primary text-sm font-bold rounded-full t hover:opacity-90 active:scale-95"
            >
              Get Started
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-20 px-6 mesh-bg">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-6">
            <Link
              to="/register"
              className="flex items-center gap-2 px-8 py-4 bg-primary text-on-primary font-black rounded-full text-lg t hover:opacity-90 active:scale-[0.98] shadow-2xl shadow-primary/20"
            >
              Get Started Free
            ...
            <a
              href="#how"
              className="flex items-center gap-2 px-8 py-4 glass-card text-on-surface font-semibold rounded-full text-lg t hover:bg-white/10"
            >
              How It Works
            </a>
          </div>
      ...
      <section className="py-24 px-6 bg-surface-container-low/50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map(f => (
              <div key={f.title} className="glass-card p-6 rounded-xl t hover:border-white/15 hover:-translate-y-1">
      ...
      <section className="py-20 px-6 bg-surface-container-low/50">
        <div className="max-w-3xl mx-auto">
          <div className="welcome-gradient rounded-2xl p-12 text-center">
            ...
            <Link
              to="/register"
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-white text-primary font-black rounded-full t hover:bg-primary-fixed active:scale-95 shadow-xl"
            >
              Create Free Account
              <span className="material-symbols-outlined">arrow_forward</span>
            </Link>
